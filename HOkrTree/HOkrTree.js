...
!(function(name, factory) {
            ...
            $.each(data, function(index, item) {
                ...
                item.children && $.each(item.children, function(index, item1) {
                    if (item1.type && item1.type == "tag") {
                        ...
                        //         </div>
                        //     </div>`;
                        tag = "<div class=\"tagBox\">\n                                                <div class=\"tagNode\">\n                                                    <div class=\"tag-line\"><div class=\"taglineDown\"></div></div>\n                                                     <div class=\"tag-node\">\n                                                          ".concat(tagCalback && tagCalback(item1), "\n                                                    </div>\n                                                     \n                                                </div>\n                                            </div>");
    ...
    $.fn[namespace] = function(options) {
        ...
        var defaults = {
            ...
            //style = `${cssNameSpace} .node-parent,${cssNameSpace} .node-childrens{display:table-cell;height:100%;vertical-align:middle}${cssNameSpace} .node{box-sizing:border-box}${cssNameSpace} .node-cell{position:relative;padding:10px;padding-left:20px}${cssNameSpace} .node-lines{position:absolute;left:0;height:100%;top:0}${cssNameSpace} .line{display:table-cell;vertical-align:middle}${cssNameSpace} .line>.line-right{width:15px;border-bottom:solid 1px ${opts.css.lineColor}}${cssNameSpace} .line-top,${cssNameSpace} .line-bottom{height:50%;border-left:solid 1px ${opts.css.lineColor};width:20px;box-sizing:border-box}${cssNameSpace} .expandIcon{display:table-cell;vertical-align:middle}${cssNameSpace} .expandIcon>div{display:inline-block;height:18px;width:18px;background:${opts.css.iconColor};color:#fff;font-size:12px;line-height:15px;border-radius:50%;position:relative;top:-2px;cursor:pointer;text-align:center}${cssNameSpace} .line-top{border-bottom:solid 1px ${opts.css.lineColor}}${cssNameSpace} .line-top.first{border:0;border-bottom:solid 1px ${opts.css.lineColor}}${cssNameSpace} .line-bottom.last{border:0}${cssNameSpace} .tagBox{display:table-cell;vertical-align:middle}${cssNameSpace} .tagNode{position:relative}${cssNameSpace} .tag-line{height:50px;border-bottom:solid 1px ${opts.css.lineColor};box-sizing:border-box;position:absolute;top:50%;margin-top:-50px;width:100%}${cssNameSpace} .tag-node{}${cssNameSpace} .taglineDown{width:0;border-left:solid 1px ${opts.css.lineColor};height:100%;margin:auto}`;
            style = "".concat(cssNameSpace, " .node-parent,").concat(cssNameSpace, " .node-childrens{display:table-cell;height:100%;vertical-align:middle}").concat(cssNameSpace, " .node{box-sizing:border-box}").concat(cssNameSpace, " .node-cell{position:relative;padding:10px;padding-left:20px}").concat(cssNameSpace, " .node-lines{position:absolute;left:0;height:100%;top:0}").concat(cssNameSpace, " .line{display:table-cell;vertical-align:middle}").concat(cssNameSpace, " .line>.line-right{width:15px;border-bottom:solid 1px ").concat(opts.css.lineColor, "}").concat(cssNameSpace, " .line-top,").concat(cssNameSpace, " .line-bottom{height:50%;border-left:solid 1px ").concat(opts.css.lineColor, ";width:20px;box-sizing:border-box}").concat(cssNameSpace, " .expandIcon{display:table-cell;vertical-align:middle}").concat(cssNameSpace, " .expandIcon>div{display:inline-block;height:18px;width:18px;background:").concat(opts.css.iconColor, ";color:#fff;font-size:12px;line-height:15px;border-radius:50%;position:relative;top:-2px;cursor:pointer;text-align:center}").concat(cssNameSpace, " .line-top{border-bottom:solid 1px ").concat(opts.css.lineColor, "}").concat(cssNameSpace, " .line-top.first{border:0;border-bottom:solid 1px ").concat(opts.css.lineColor, "}").concat(cssNameSpace, " .line-bottom.last{border:0}").concat(cssNameSpace, " .tagBox{display:table-cell;vertical-align:middle}").concat(cssNameSpace, " .tagNode{position:relative}").concat(cssNameSpace, " .tag-line{height:50px;border-bottom:solid 1px ").concat(opts.css.lineColor, ";box-sizing:border-box;position:absolute;top:50%;margin-top:-50px;width:100%}").concat(cssNameSpace, " .tag-node{}").concat(cssNameSpace, " .taglineDown{width:0;border-left:solid 1px ").concat(opts.css.lineColor, ";height:100%;margin:auto}");
